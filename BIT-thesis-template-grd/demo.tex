...
\title{基于地理位置区块链的出租车调度系统设计与实现}
\vtitle{基于地理位置区块链的出租车调度系统设计与实现}
\author{成佳壮}
\institute{计算机学院}
\advisor{陆慧梅副教授}
\chairman{李凡教授}
...
% 英文封面内容(关注内容而不是表现形式)
\englishtitle{Design and Implementation of Taxi Dispatch System on Geographic Location Blockchain}
\englishauthor{Jiazhuang Cheng}
\englishadvisor{Prof. Huimei Lu}
\englishchairman{Prof. Fan Li}
...
\englishmajor{Electronic Information}
\englishdate{June, 2022}
